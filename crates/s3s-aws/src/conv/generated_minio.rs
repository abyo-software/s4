...
impl AwsConversion for s3s::dto::AnalyticsConfiguration {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            storage_class_analysis: unwrap_from_aws(
                x.storage_class_analysis,
...
impl AwsConversion for s3s::dto::AnalyticsExportDestination {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            s3_bucket_destination: unwrap_from_aws(
                x.s3_bucket_destination,
...
impl AwsConversion for s3s::dto::AnalyticsS3ExportFileFormat {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::AnalyticsS3ExportFileFormat::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::ArchiveStatus {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ArchiveStatus::ArchiveAccess => {
                Self::from_static(Self::ARCHIVE_ACCESS)
            }
            aws_sdk_s3::types::ArchiveStatus::DeepArchiveAccess => {
                Self::from_static(Self::DEEP_ARCHIVE_ACCESS)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            ...
            aws_sdk_s3::types::BucketAccelerateStatus::Suspended => {
                Self::from_static(Self::SUSPENDED)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::BucketCannedACL {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::BucketCannedAcl::AuthenticatedRead => {
                Self::from_static(Self::AUTHENTICATED_READ)
            }
            ...
            aws_sdk_s3::types::BucketCannedAcl::PublicReadWrite => {
                Self::from_static(Self::PUBLIC_READ_WRITE)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::BucketLocationConstraint {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            ...
            aws_sdk_s3::types::BucketLocationConstraint::AfSouth1 => {
                Self::from_static(Self::AF_SOUTH_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApEast1 => {
                Self::from_static(Self::AP_EAST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApNortheast1 => {
                Self::from_static(Self::AP_NORTHEAST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApNortheast2 => {
                Self::from_static(Self::AP_NORTHEAST_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApNortheast3 => {
                Self::from_static(Self::AP_NORTHEAST_3)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSouth1 => {
                Self::from_static(Self::AP_SOUTH_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSouth2 => {
                Self::from_static(Self::AP_SOUTH_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSoutheast1 => {
                Self::from_static(Self::AP_SOUTHEAST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSoutheast2 => {
                Self::from_static(Self::AP_SOUTHEAST_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSoutheast3 => {
                Self::from_static(Self::AP_SOUTHEAST_3)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSoutheast4 => {
                Self::from_static(Self::AP_SOUTHEAST_4)
            }
            aws_sdk_s3::types::BucketLocationConstraint::ApSoutheast5 => {
                Self::from_static(Self::AP_SOUTHEAST_5)
            }
            aws_sdk_s3::types::BucketLocationConstraint::CaCentral1 => {
                Self::from_static(Self::CA_CENTRAL_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::CnNorth1 => {
                Self::from_static(Self::CN_NORTH_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::CnNorthwest1 => {
                Self::from_static(Self::CN_NORTHWEST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuCentral1 => {
                Self::from_static(Self::EU_CENTRAL_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuCentral2 => {
                Self::from_static(Self::EU_CENTRAL_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuNorth1 => {
                Self::from_static(Self::EU_NORTH_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuSouth1 => {
                Self::from_static(Self::EU_SOUTH_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuSouth2 => {
                Self::from_static(Self::EU_SOUTH_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuWest1 => {
                Self::from_static(Self::EU_WEST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuWest2 => {
                Self::from_static(Self::EU_WEST_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::EuWest3 => {
                Self::from_static(Self::EU_WEST_3)
            }
            aws_sdk_s3::types::BucketLocationConstraint::IlCentral1 => {
                Self::from_static(Self::IL_CENTRAL_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::MeCentral1 => {
                Self::from_static(Self::ME_CENTRAL_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::MeSouth1 => {
                Self::from_static(Self::ME_SOUTH_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::SaEast1 => {
                Self::from_static(Self::SA_EAST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::UsEast2 => {
                Self::from_static(Self::US_EAST_2)
            }
            aws_sdk_s3::types::BucketLocationConstraint::UsGovEast1 => {
                Self::from_static(Self::US_GOV_EAST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::UsGovWest1 => {
                Self::from_static(Self::US_GOV_WEST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::UsWest1 => {
                Self::from_static(Self::US_WEST_1)
            }
            aws_sdk_s3::types::BucketLocationConstraint::UsWest2 => {
                Self::from_static(Self::US_WEST_2)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::BucketLocationConstraint::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::BucketLogsPermission {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::BucketLogsPermission::FullControl => {
                Self::from_static(Self::FULL_CONTROL)
            }
...
impl AwsConversion for s3s::dto::CopyObjectInput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_copy_source_sse_customer_algorithm(try_into_aws(
            x.copy_source_sse_customer_algorithm,
        )?);
        y = y.set_copy_source_sse_customer_key(try_into_aws(x.copy_source_sse_customer_key)?);
        y = y.set_copy_source_sse_customer_key_md5(try_into_aws(
            x.copy_source_sse_customer_key_md5,
        )?);
        y = y.set_expected_bucket_owner(try_into_aws(x.expected_bucket_owner)?);
...
impl AwsConversion for s3s::dto::CreateBucketMetadataTableConfigurationInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            metadata_table_configuration: unwrap_from_aws(
                x.metadata_table_configuration,
...
impl AwsConversion for s3s::dto::DataRedundancy {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::DataRedundancy::SingleAvailabilityZone => {
                Self::from_static(Self::SINGLE_AVAILABILITY_ZONE)
            }
            aws_sdk_s3::types::DataRedundancy::SingleLocalZone => {
                Self::from_static(Self::SINGLE_LOCAL_ZONE)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::DeleteBucketOwnershipControlsInput {
    type Target =
        aws_sdk_s3::operation::delete_bucket_ownership_controls::DeleteBucketOwnershipControlsInput;
    type Error = S3Error;
...
impl AwsConversion for s3s::dto::DeleteMarkerReplicationStatus {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::DeleteMarkerReplicationStatus::Disabled => {
                Self::from_static(Self::DISABLED)
            }
            aws_sdk_s3::types::DeleteMarkerReplicationStatus::Enabled => {
                Self::from_static(Self::ENABLED)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::DeleteMarkerReplicationStatus::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::ExistingObjectReplicationStatus {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ExistingObjectReplicationStatus::Disabled => {
                Self::from_static(Self::DISABLED)
            }
            aws_sdk_s3::types::ExistingObjectReplicationStatus::Enabled => {
                Self::from_static(Self::ENABLED)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::ExistingObjectReplicationStatus::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::GetBucketEncryptionOutput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            server_side_encryption_configuration: try_from_aws(
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_server_side_encryption_configuration(try_into_aws(
            x.server_side_encryption_configuration,
        )?);
        Ok(y.build())
    }
...
impl AwsConversion for s3s::dto::GetBucketIntelligentTieringConfigurationOutput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_intelligent_tiering_configuration(try_into_aws(
...
impl AwsConversion for s3s::dto::GetBucketLifecycleConfigurationOutput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            rules: try_from_aws(x.rules)?,
            transition_default_minimum_object_size: try_from_aws(
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_transition_default_minimum_object_size(try_into_aws(
            x.transition_default_minimum_object_size,
        )?);
        Ok(y.build())
    }
...
impl AwsConversion for s3s::dto::GetBucketMetadataTableConfigurationOutput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            get_bucket_metadata_table_configuration_result: try_from_aws(
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_get_bucket_metadata_table_configuration_result(try_into_aws(
            x.get_bucket_metadata_table_configuration_result,
        )?);
        Ok(y.build())
    }
...
impl AwsConversion for s3s::dto::GetBucketMetadataTableConfigurationResult {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_metadata_table_configuration_result(Some(try_into_aws(
            x.metadata_table_configuration_result,
        )?));
        y = y.set_status(Some(try_into_aws(x.status)?));
        y.build().map_err(S3Error::internal_error)
...
impl AwsConversion for s3s::dto::GetBucketMetricsConfigurationInput {
    type Target =
        aws_sdk_s3::operation::get_bucket_metrics_configuration::GetBucketMetricsConfigurationInput;
    type Error = S3Error;
...
impl AwsConversion for s3s::dto::GetBucketOwnershipControlsInput {
    type Target =
        aws_sdk_s3::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsInput;
    type Error = S3Error;
...
impl AwsConversion for s3s::dto::GetObjectAttributesInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            part_number_marker: x
                .part_number_marker
                .as_deref()
                .map(integer_from_string)
                .transpose()?,
            request_payer: try_from_aws(x.request_payer)?,
            sse_customer_algorithm: try_from_aws(x.sse_customer_algorithm)?,
            sse_customer_key: try_from_aws(x.sse_customer_key)?,
...
impl AwsConversion for s3s::dto::GetObjectLockConfigurationInput {
    type Target =
        aws_sdk_s3::operation::get_object_lock_configuration::GetObjectLockConfigurationInput;
    type Error = S3Error;
...
impl AwsConversion for s3s::dto::GetPublicAccessBlockOutput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_public_access_block_configuration(try_into_aws(
...
impl AwsConversion for s3s::dto::IntelligentTieringAccessTier {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::IntelligentTieringAccessTier::ArchiveAccess => {
                Self::from_static(Self::ARCHIVE_ACCESS)
            }
            aws_sdk_s3::types::IntelligentTieringAccessTier::DeepArchiveAccess => {
                Self::from_static(Self::DEEP_ARCHIVE_ACCESS)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::IntelligentTieringAccessTier::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::IntelligentTieringStatus {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::IntelligentTieringStatus::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::InventoryIncludedObjectVersions {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::InventoryIncludedObjectVersions::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::InventoryOptionalField {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::InventoryOptionalField::BucketKeyStatus => {
                Self::from_static(Self::BUCKET_KEY_STATUS)
            }
            aws_sdk_s3::types::InventoryOptionalField::ChecksumAlgorithm => {
                Self::from_static(Self::CHECKSUM_ALGORITHM)
            }
            aws_sdk_s3::types::InventoryOptionalField::ETag => Self::from_static(Self::E_TAG),
            aws_sdk_s3::types::InventoryOptionalField::EncryptionStatus => {
                Self::from_static(Self::ENCRYPTION_STATUS)
            }
            ...
            aws_sdk_s3::types::InventoryOptionalField::IsMultipartUploaded => {
                Self::from_static(Self::IS_MULTIPART_UPLOADED)
            }
            aws_sdk_s3::types::InventoryOptionalField::LastModifiedDate => {
                Self::from_static(Self::LAST_MODIFIED_DATE)
            }
            ...
            aws_sdk_s3::types::InventoryOptionalField::ObjectLockMode => {
                Self::from_static(Self::OBJECT_LOCK_MODE)
            }
            aws_sdk_s3::types::InventoryOptionalField::ObjectLockRetainUntilDate => {
                Self::from_static(Self::OBJECT_LOCK_RETAIN_UNTIL_DATE)
            }
            aws_sdk_s3::types::InventoryOptionalField::ObjectOwner => {
                Self::from_static(Self::OBJECT_OWNER)
            }
            aws_sdk_s3::types::InventoryOptionalField::ReplicationStatus => {
                Self::from_static(Self::REPLICATION_STATUS)
            }
            aws_sdk_s3::types::InventoryOptionalField::Size => Self::from_static(Self::SIZE),
            aws_sdk_s3::types::InventoryOptionalField::StorageClass => {
                Self::from_static(Self::STORAGE_CLASS)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::LifecycleRule {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_abort_incomplete_multipart_upload(try_into_aws(
            x.abort_incomplete_multipart_upload,
        )?);
        y = y.set_expiration(try_into_aws(x.expiration)?);
        y = y.set_filter(try_into_aws(x.filter)?);
        y = y.set_id(try_into_aws(x.id)?);
...
impl AwsConversion for s3s::dto::ListBucketIntelligentTieringConfigurationsOutput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            continuation_token: try_from_aws(x.continuation_token)?,
            intelligent_tiering_configuration_list: try_from_aws(
                x.intelligent_tiering_configuration_list,
            )?,
            is_truncated: try_from_aws(x.is_truncated)?,
            next_continuation_token: try_from_aws(x.next_continuation_token)?,
        })
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_continuation_token(try_into_aws(x.continuation_token)?);
        y = y.set_intelligent_tiering_configuration_list(try_into_aws(
            x.intelligent_tiering_configuration_list,
        )?);
        y = y.set_is_truncated(try_into_aws(x.is_truncated)?);
        y = y.set_next_continuation_token(try_into_aws(x.next_continuation_token)?);
...
impl AwsConversion for s3s::dto::LocationType {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::LocationType::AvailabilityZone => {
                Self::from_static(Self::AVAILABILITY_ZONE)
            }
...
impl AwsConversion for s3s::dto::MetadataTableConfiguration {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            s3_tables_destination: unwrap_from_aws(
                x.s3_tables_destination,
...
impl AwsConversion for s3s::dto::MetadataTableConfigurationResult {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            s3_tables_destination_result: unwrap_from_aws(
                x.s3_tables_destination_result,
...
impl AwsConversion for s3s::dto::MetricsFilter {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::MetricsFilter::AccessPointArn(v) => {
                Self::AccessPointArn(try_from_aws(v)?)
            }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(match x {
            Self::AccessPointArn(v) => {
                aws_sdk_s3::types::MetricsFilter::AccessPointArn(try_into_aws(v)?)
            }
...
impl AwsConversion for s3s::dto::ObjectAttributes {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            ...
            aws_sdk_s3::types::ObjectAttributes::ObjectParts => {
                Self::from_static(Self::OBJECT_PARTS)
            }
            aws_sdk_s3::types::ObjectAttributes::ObjectSize => Self::from_static(Self::OBJECT_SIZE),
            aws_sdk_s3::types::ObjectAttributes::StorageClass => {
                Self::from_static(Self::STORAGE_CLASS)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
...
impl AwsConversion for s3s::dto::ObjectCannedACL {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ObjectCannedAcl::AuthenticatedRead => {
                Self::from_static(Self::AUTHENTICATED_READ)
            }
            aws_sdk_s3::types::ObjectCannedAcl::AwsExecRead => {
                Self::from_static(Self::AWS_EXEC_READ)
            }
            aws_sdk_s3::types::ObjectCannedAcl::BucketOwnerFullControl => {
                Self::from_static(Self::BUCKET_OWNER_FULL_CONTROL)
            }
            aws_sdk_s3::types::ObjectCannedAcl::BucketOwnerRead => {
                Self::from_static(Self::BUCKET_OWNER_READ)
            }
            ...
            aws_sdk_s3::types::ObjectCannedAcl::PublicReadWrite => {
                Self::from_static(Self::PUBLIC_READ_WRITE)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
...
impl AwsConversion for s3s::dto::ObjectLockLegalHoldStatus {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::ObjectLockLegalHoldStatus::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::ObjectLockRetentionMode {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ObjectLockRetentionMode::Compliance => {
                Self::from_static(Self::COMPLIANCE)
            }
            aws_sdk_s3::types::ObjectLockRetentionMode::Governance => {
                Self::from_static(Self::GOVERNANCE)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ObjectOwnership::BucketOwnerEnforced => {
                Self::from_static(Self::BUCKET_OWNER_ENFORCED)
            }
            aws_sdk_s3::types::ObjectOwnership::BucketOwnerPreferred => {
                Self::from_static(Self::BUCKET_OWNER_PREFERRED)
            }
            aws_sdk_s3::types::ObjectOwnership::ObjectWriter => {
                Self::from_static(Self::OBJECT_WRITER)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ObjectStorageClass::DeepArchive => {
                Self::from_static(Self::DEEP_ARCHIVE)
            }
            aws_sdk_s3::types::ObjectStorageClass::ExpressOnezone => {
                Self::from_static(Self::EXPRESS_ONEZONE)
            }
            ...
            aws_sdk_s3::types::ObjectStorageClass::IntelligentTiering => {
                Self::from_static(Self::INTELLIGENT_TIERING)
            }
            ...
            aws_sdk_s3::types::ObjectStorageClass::ReducedRedundancy => {
                Self::from_static(Self::REDUCED_REDUNDANCY)
            }
            ...
            aws_sdk_s3::types::ObjectStorageClass::StandardIa => {
                Self::from_static(Self::STANDARD_IA)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::ObjectVersionStorageClass {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ObjectVersionStorageClass::Standard => {
                Self::from_static(Self::STANDARD)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::ObjectVersionStorageClass::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::OptionalObjectAttributes {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::OptionalObjectAttributes::RestoreStatus => {
                Self::from_static(Self::RESTORE_STATUS)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::OptionalObjectAttributes::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::PartitionDateSource {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::PartitionDateSource::DeliveryTime => {
                Self::from_static(Self::DELIVERY_TIME)
            }
            aws_sdk_s3::types::PartitionDateSource::EventTime => {
                Self::from_static(Self::EVENT_TIME)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::PutBucketAccelerateConfigurationInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            accelerate_configuration: unwrap_from_aws(
                x.accelerate_configuration,
...
impl AwsConversion for s3s::dto::PutBucketAnalyticsConfigurationInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            analytics_configuration: unwrap_from_aws(
                x.analytics_configuration,
...
impl AwsConversion for s3s::dto::PutBucketEncryptionInput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_content_md5(try_into_aws(x.content_md5)?);
        y = y.set_expected_bucket_owner(try_into_aws(x.expected_bucket_owner)?);
        y = y.set_server_side_encryption_configuration(Some(try_into_aws(
            x.server_side_encryption_configuration,
        )?));
        y.build().map_err(S3Error::internal_error)
    }
...
impl AwsConversion for s3s::dto::PutBucketIntelligentTieringConfigurationInput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_bucket(Some(try_into_aws(x.bucket)?));
        y = y.set_id(Some(try_into_aws(x.id)?));
        y = y.set_intelligent_tiering_configuration(Some(try_into_aws(
            x.intelligent_tiering_configuration,
        )?));
        y.build().map_err(S3Error::internal_error)
    }
...
impl AwsConversion for s3s::dto::PutBucketInventoryConfigurationInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            id: unwrap_from_aws(x.id, "id")?,
            inventory_configuration: unwrap_from_aws(
...
impl AwsConversion for s3s::dto::PutBucketLoggingInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            bucket: unwrap_from_aws(x.bucket, "bucket")?,
            bucket_logging_status: unwrap_from_aws(
                x.bucket_logging_status,
...
impl AwsConversion for s3s::dto::PutBucketMetricsConfigurationInput {
    type Target =
        aws_sdk_s3::operation::put_bucket_metrics_configuration::PutBucketMetricsConfigurationInput;
    type Error = S3Error;
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            id: unwrap_from_aws(x.id, "id")?,
            metrics_configuration: unwrap_from_aws(
                x.metrics_configuration,
...
impl AwsConversion for s3s::dto::PutBucketNotificationConfigurationInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            bucket: unwrap_from_aws(x.bucket, "bucket")?,
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            notification_configuration: unwrap_from_aws(
...
impl AwsConversion for s3s::dto::PutBucketOwnershipControlsInput {
    type Target =
        aws_sdk_s3::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsInput;
    type Error = S3Error;
...
impl AwsConversion for s3s::dto::PutBucketPolicyInput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_bucket(Some(try_into_aws(x.bucket)?));
        y = y.set_checksum_algorithm(try_into_aws(x.checksum_algorithm)?);
        y = y.set_confirm_remove_self_bucket_access(try_into_aws(
...
impl AwsConversion for s3s::dto::PutBucketReplicationInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            content_md5: try_from_aws(x.content_md5)?,
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            replication_configuration: unwrap_from_aws(
...
impl AwsConversion for s3s::dto::PutBucketRequestPaymentInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            content_md5: try_from_aws(x.content_md5)?,
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            request_payment_configuration: unwrap_from_aws(
                x.request_payment_configuration,
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_content_md5(try_into_aws(x.content_md5)?);
        y = y.set_expected_bucket_owner(try_into_aws(x.expected_bucket_owner)?);
        y = y.set_request_payment_configuration(Some(try_into_aws(
            x.request_payment_configuration,
        )?));
        y.build().map_err(S3Error::internal_error)
    }
...
impl AwsConversion for s3s::dto::PutBucketVersioningInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            mfa: try_from_aws(x.mfa)?,
            versioning_configuration: unwrap_from_aws(
                x.versioning_configuration,
...
impl AwsConversion for s3s::dto::PutBucketWebsiteInput {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            ...
            content_md5: try_from_aws(x.content_md5)?,
            expected_bucket_owner: try_from_aws(x.expected_bucket_owner)?,
            website_configuration: unwrap_from_aws(
                x.website_configuration,
...
impl AwsConversion for s3s::dto::PutObjectLockConfigurationInput {
    type Target =
        aws_sdk_s3::operation::put_object_lock_configuration::PutObjectLockConfigurationInput;
    type Error = S3Error;
...
impl AwsConversion for s3s::dto::PutPublicAccessBlockInput {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        ...
        y = y.set_content_md5(try_into_aws(x.content_md5)?);
        y = y.set_expected_bucket_owner(try_into_aws(x.expected_bucket_owner)?);
        y = y.set_public_access_block_configuration(Some(try_into_aws(
            x.public_access_block_configuration,
        )?));
        y.build().map_err(S3Error::internal_error)
    }
...
impl AwsConversion for s3s::dto::ReplicaModificationsStatus {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::ReplicaModificationsStatus::Disabled => {
                Self::from_static(Self::DISABLED)
            }
            aws_sdk_s3::types::ReplicaModificationsStatus::Enabled => {
                Self::from_static(Self::ENABLED)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::ReplicaModificationsStatus::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::SelectObjectContentEvent {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::SelectObjectContentEventStream::Cont(v) => {
                Self::Cont(try_from_aws(v)?)
            }
            aws_sdk_s3::types::SelectObjectContentEventStream::End(v) => {
                Self::End(try_from_aws(v)?)
            }
            aws_sdk_s3::types::SelectObjectContentEventStream::Progress(v) => {
                Self::Progress(try_from_aws(v)?)
            }
            aws_sdk_s3::types::SelectObjectContentEventStream::Records(v) => {
                Self::Records(try_from_aws(v)?)
            }
            aws_sdk_s3::types::SelectObjectContentEventStream::Stats(v) => {
                Self::Stats(try_from_aws(v)?)
            }
            _ => unimplemented!(
                "unknown variant of aws_sdk_s3::types::SelectObjectContentEventStream: {x:?}"
            ),
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(match x {
            Self::Cont(v) => {
                aws_sdk_s3::types::SelectObjectContentEventStream::Cont(try_into_aws(v)?)
            }
            Self::End(v) => {
                aws_sdk_s3::types::SelectObjectContentEventStream::End(try_into_aws(v)?)
            }
            Self::Progress(v) => {
                aws_sdk_s3::types::SelectObjectContentEventStream::Progress(try_into_aws(v)?)
            }
            Self::Records(v) => {
                aws_sdk_s3::types::SelectObjectContentEventStream::Records(try_into_aws(v)?)
            }
            Self::Stats(v) => {
                aws_sdk_s3::types::SelectObjectContentEventStream::Stats(try_into_aws(v)?)
            }
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            ...
            aws_sdk_s3::types::ServerSideEncryption::AwsKmsDsse => {
                Self::from_static(Self::AWS_KMS_DSSE)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
...
impl AwsConversion for s3s::dto::ServerSideEncryptionRule {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(Self {
            apply_server_side_encryption_by_default: try_from_aws(
                x.apply_server_side_encryption_by_default,
            )?,
            bucket_key_enabled: try_from_aws(x.bucket_key_enabled)?,
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        let mut y = Self::Target::builder();
        y = y.set_apply_server_side_encryption_by_default(try_into_aws(
            x.apply_server_side_encryption_by_default,
        )?);
        y = y.set_bucket_key_enabled(try_into_aws(x.bucket_key_enabled)?);
        Ok(y.build())
...
impl AwsConversion for s3s::dto::SseKmsEncryptedObjectsStatus {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::SseKmsEncryptedObjectsStatus::Disabled => {
                Self::from_static(Self::DISABLED)
            }
            aws_sdk_s3::types::SseKmsEncryptedObjectsStatus::Enabled => {
                Self::from_static(Self::ENABLED)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::SseKmsEncryptedObjectsStatus::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::StorageClass {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            ...
            aws_sdk_s3::types::StorageClass::ExpressOnezone => {
                Self::from_static(Self::EXPRESS_ONEZONE)
            }
...
impl AwsConversion for s3s::dto::StorageClassAnalysisSchemaVersion {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::StorageClassAnalysisSchemaVersion::V1 => {
                Self::from_static(Self::V_1)
            }
            _ => Self::from(x.as_str().to_owned()),
        })
    }
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::StorageClassAnalysisSchemaVersion::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::TransitionDefaultMinimumObjectSize {
    ...
    fn try_into_aws(x: Self) -> S3Result<Self::Target> {
        Ok(aws_sdk_s3::types::TransitionDefaultMinimumObjectSize::from(
            x.as_str(),
        ))
    }
}
...
impl AwsConversion for s3s::dto::Type {
    ...
    fn try_from_aws(x: Self::Target) -> S3Result<Self> {
        Ok(match x {
            aws_sdk_s3::types::Type::AmazonCustomerByEmail => {
                Self::from_static(Self::AMAZON_CUSTOMER_BY_EMAIL)
            }
