...
impl S3 for Proxy {
    ...
    async fn copy_object(
        &self,
        req: S3Request<s3s::dto::CopyObjectInput>,
    ) -> S3Result<S3Response<s3s::dto::CopyObjectOutput>> {
        let input = req.input;
        debug!(?input);
        ...
        b = b.set_copy_source_if_unmodified_since(try_into_aws(
            input.copy_source_if_unmodified_since,
        )?);
        b = b.set_copy_source_sse_customer_algorithm(try_into_aws(
        ...
        b = b.set_copy_source_sse_customer_key_md5(try_into_aws(
    ...
    async fn create_bucket(
        ...
        b = b.set_grant_write_acp(try_into_aws(input.grant_write_acp)?);
        b = b.set_object_lock_enabled_for_bucket(try_into_aws(
    ...
    async fn create_bucket_metadata_table_configuration(
        ...
        b = b.set_expected_bucket_owner(try_into_aws(input.expected_bucket_owner)?);
        b = b.set_metadata_table_configuration(Some(try_into_aws(
    ...
    async fn put_bucket_encryption(
        ...
        b = b.set_content_md5(try_into_aws(input.content_md5)?);
        b = b.set_expected_bucket_owner(try_into_aws(input.expected_bucket_owner)?);
        b = b.set_server_side_encryption_configuration(Some(try_into_aws(
    ...
    async fn put_bucket_intelligent_tiering_configuration(
        ...
        b = b.set_bucket(Some(try_into_aws(input.bucket)?));
        b = b.set_id(Some(try_into_aws(input.id)?));
        b = b.set_intelligent_tiering_configuration(Some(try_into_aws(
    ...
    async fn put_bucket_lifecycle_configuration(
        ...
        b = b.set_transition_default_minimum_object_size(try_into_aws(
    ...
    async fn put_bucket_policy(
        ...
        b = b.set_bucket(Some(try_into_aws(input.bucket)?));
        b = b.set_checksum_algorithm(try_into_aws(input.checksum_algorithm)?);
        b = b.set_confirm_remove_self_bucket_access(try_into_aws(
    ...
    async fn put_bucket_request_payment(
        ...
        b = b.set_content_md5(try_into_aws(input.content_md5)?);
        b = b.set_expected_bucket_owner(try_into_aws(input.expected_bucket_owner)?);
        b = b.set_request_payment_configuration(Some(try_into_aws(
    ...
    async fn put_public_access_block(
        ...
        b = b.set_content_md5(try_into_aws(input.content_md5)?);
        b = b.set_expected_bucket_owner(try_into_aws(input.expected_bucket_owner)?);
        b = b.set_public_access_block_configuration(Some(try_into_aws(
