use s3s::dto::{
    AnalyticsConfiguration, BucketLifecycleConfiguration, GetObjectInput,
    IntelligentTieringConfiguration, InventoryConfiguration, LambdaFunctionConfiguration,
    ListObjectsV2Input, ListObjectsV2Output, MetadataTableConfiguration, MetricsConfiguration,
    PutObjectOutput, QueueConfiguration, ReplicationConfiguration, RequestPaymentConfiguration,
    TopicConfiguration,
};
