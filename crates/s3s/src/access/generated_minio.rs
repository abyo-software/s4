...
pub trait S3Access: Send + Sync + 'static {
    ...
    async fn abort_multipart_upload(
        &self,
        _req: &mut S3Request<AbortMultipartUploadInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn complete_multipart_upload(
        &self,
        _req: &mut S3Request<CompleteMultipartUploadInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn create_multipart_upload(
        &self,
        _req: &mut S3Request<CreateMultipartUploadInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_cors(
        &self,
        _req: &mut S3Request<DeleteBucketCorsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_encryption(
        &self,
        _req: &mut S3Request<DeleteBucketEncryptionInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_lifecycle(
        &self,
        _req: &mut S3Request<DeleteBucketLifecycleInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_ownership_controls(
        &self,
        _req: &mut S3Request<DeleteBucketOwnershipControlsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_policy(
        &self,
        _req: &mut S3Request<DeleteBucketPolicyInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_replication(
        &self,
        _req: &mut S3Request<DeleteBucketReplicationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_tagging(
        &self,
        _req: &mut S3Request<DeleteBucketTaggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_bucket_website(
        &self,
        _req: &mut S3Request<DeleteBucketWebsiteInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_object_tagging(
        &self,
        _req: &mut S3Request<DeleteObjectTaggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn delete_public_access_block(
        &self,
        _req: &mut S3Request<DeletePublicAccessBlockInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_encryption(
        &self,
        _req: &mut S3Request<GetBucketEncryptionInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_location(
        &self,
        _req: &mut S3Request<GetBucketLocationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_logging(
        &self,
        _req: &mut S3Request<GetBucketLoggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_metrics_configuration(
        &self,
        _req: &mut S3Request<GetBucketMetricsConfigurationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_ownership_controls(
        &self,
        _req: &mut S3Request<GetBucketOwnershipControlsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_policy_status(
        &self,
        _req: &mut S3Request<GetBucketPolicyStatusInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_replication(
        &self,
        _req: &mut S3Request<GetBucketReplicationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_request_payment(
        &self,
        _req: &mut S3Request<GetBucketRequestPaymentInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_tagging(
        &self,
        _req: &mut S3Request<GetBucketTaggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_versioning(
        &self,
        _req: &mut S3Request<GetBucketVersioningInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_bucket_website(
        &self,
        _req: &mut S3Request<GetBucketWebsiteInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_object_attributes(
        &self,
        _req: &mut S3Request<GetObjectAttributesInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_object_legal_hold(
        &self,
        _req: &mut S3Request<GetObjectLegalHoldInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_object_lock_configuration(
        &self,
        _req: &mut S3Request<GetObjectLockConfigurationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_object_retention(
        &self,
        _req: &mut S3Request<GetObjectRetentionInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_object_tagging(
        &self,
        _req: &mut S3Request<GetObjectTaggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_object_torrent(
        &self,
        _req: &mut S3Request<GetObjectTorrentInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn get_public_access_block(
        &self,
        _req: &mut S3Request<GetPublicAccessBlockInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn list_directory_buckets(
        &self,
        _req: &mut S3Request<ListDirectoryBucketsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn list_multipart_uploads(
        &self,
        _req: &mut S3Request<ListMultipartUploadsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn list_object_versions(
        &self,
        _req: &mut S3Request<ListObjectVersionsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_encryption(
        &self,
        _req: &mut S3Request<PutBucketEncryptionInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_logging(
        &self,
        _req: &mut S3Request<PutBucketLoggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_metrics_configuration(
        &self,
        _req: &mut S3Request<PutBucketMetricsConfigurationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_ownership_controls(
        &self,
        _req: &mut S3Request<PutBucketOwnershipControlsInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_replication(
        &self,
        _req: &mut S3Request<PutBucketReplicationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_request_payment(
        &self,
        _req: &mut S3Request<PutBucketRequestPaymentInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_tagging(
        &self,
        _req: &mut S3Request<PutBucketTaggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_versioning(
        &self,
        _req: &mut S3Request<PutBucketVersioningInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_bucket_website(
        &self,
        _req: &mut S3Request<PutBucketWebsiteInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_object_legal_hold(
        &self,
        _req: &mut S3Request<PutObjectLegalHoldInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_object_lock_configuration(
        &self,
        _req: &mut S3Request<PutObjectLockConfigurationInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_object_retention(
        &self,
        _req: &mut S3Request<PutObjectRetentionInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_object_tagging(
        &self,
        _req: &mut S3Request<PutObjectTaggingInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn put_public_access_block(
        &self,
        _req: &mut S3Request<PutPublicAccessBlockInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn select_object_content(
        &self,
        _req: &mut S3Request<SelectObjectContentInput>,
    ) -> S3Result<()> {
        Ok(())
    }
    ...
    async fn write_get_object_response(
        &self,
        _req: &mut S3Request<WriteGetObjectResponseInput>,
    ) -> S3Result<()> {
        Ok(())
    }
}
