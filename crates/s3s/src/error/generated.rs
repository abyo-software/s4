...
impl S3ErrorCode {
    ...
    pub fn from_bytes(s: &[u8]) -> Option<Self> {
        match s {
            ...
            b"EvaluatorInvalidTimestampFormatPattern" => {
                Some(Self::EvaluatorInvalidTimestampFormatPattern)
            }
            b"EvaluatorInvalidTimestampFormatPatternSymbol" => {
                Some(Self::EvaluatorInvalidTimestampFormatPatternSymbol)
            }
            ...
            b"EvaluatorInvalidTimestampFormatPatternToken" => {
                Some(Self::EvaluatorInvalidTimestampFormatPatternToken)
            }
            b"EvaluatorLikePatternInvalidEscapeSequence" => {
                Some(Self::EvaluatorLikePatternInvalidEscapeSequence)
            }
            b"EvaluatorNegativeLimit" => Some(Self::EvaluatorNegativeLimit),
            b"EvaluatorTimestampFormatPatternDuplicateFields" => {
                Some(Self::EvaluatorTimestampFormatPatternDuplicateFields)
            }
            ...
            b"EvaluatorUnterminatedTimestampFormatPatternToken" => {
                Some(Self::EvaluatorUnterminatedTimestampFormatPatternToken)
            }
            ...
            b"IllegalVersioningConfigurationException" => {
                Some(Self::IllegalVersioningConfigurationException)
            }
            b"IncompleteBody" => Some(Self::IncompleteBody),
            b"IncorrectEndpoint" => Some(Self::IncorrectEndpoint),
            b"IncorrectNumberOfFilesInPostRequest" => {
                Some(Self::IncorrectNumberOfFilesInPostRequest)
            }
            ...
            b"InvalidBucketAclWithObjectOwnership" => {
                Some(Self::InvalidBucketAclWithObjectOwnership)
            }
            ...
            b"ObjectLockConfigurationNotFoundError" => {
                Some(Self::ObjectLockConfigurationNotFoundError)
            }
            ...
            b"ParseAsteriskIsNotAloneInSelectList" => {
                Some(Self::ParseAsteriskIsNotAloneInSelectList)
            }
            b"ParseCannotMixSqbAndWildcardInSelectList" => {
                Some(Self::ParseCannotMixSqbAndWildcardInSelectList)
            }
            ...
            b"ParseExpectedLeftParenBuiltinFunctionCall" => {
                Some(Self::ParseExpectedLeftParenBuiltinFunctionCall)
            }
            b"ParseExpectedLeftParenValueConstructor" => {
                Some(Self::ParseExpectedLeftParenValueConstructor)
            }
            b"ParseExpectedMember" => Some(Self::ParseExpectedMember),
            b"ParseExpectedNumber" => Some(Self::ParseExpectedNumber),
            b"ParseExpectedRightParenBuiltinFunctionCall" => {
                Some(Self::ParseExpectedRightParenBuiltinFunctionCall)
            }
            ...
            b"ParseInvalidContextForWildcardInSelectList" => {
                Some(Self::ParseInvalidContextForWildcardInSelectList)
            }
            ...
            b"ReplicationConfigurationNotFoundError" => {
                Some(Self::ReplicationConfigurationNotFoundError)
            }
            ...
            b"ServerSideEncryptionConfigurationNotFoundError" => {
                Some(Self::ServerSideEncryptionConfigurationNotFoundError)
            }
            ...
            b"TooManyMultiRegionAccessPointregionsError" => {
                Some(Self::TooManyMultiRegionAccessPointregionsError)
            }
