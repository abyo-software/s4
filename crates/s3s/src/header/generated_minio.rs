...
pub const X_AMZ_ACCESS_POINT_ALIAS: HeaderName =
    HeaderName::from_static("x-amz-access-point-alias");
...
pub const X_AMZ_BUCKET_LOCATION_NAME: HeaderName =
    HeaderName::from_static("x-amz-bucket-location-name");

pub const X_AMZ_BUCKET_LOCATION_TYPE: HeaderName =
    HeaderName::from_static("x-amz-bucket-location-type");

pub const X_AMZ_BUCKET_OBJECT_LOCK_ENABLED: HeaderName =
    HeaderName::from_static("x-amz-bucket-object-lock-enabled");

pub const X_AMZ_BUCKET_OBJECT_LOCK_TOKEN: HeaderName =
    HeaderName::from_static("x-amz-bucket-object-lock-token");

pub const X_AMZ_BUCKET_REGION: HeaderName = HeaderName::from_static("x-amz-bucket-region");

pub const X_AMZ_BYPASS_GOVERNANCE_RETENTION: HeaderName =
...
pub const X_AMZ_COPY_SOURCE_VERSION_ID: HeaderName =
    HeaderName::from_static("x-amz-copy-source-version-id");

pub const X_AMZ_CREATE_SESSION_MODE: HeaderName =
    HeaderName::from_static("x-amz-create-session-mode");

pub const X_AMZ_DATE: HeaderName = HeaderName::from_static("x-amz-date");

pub const X_AMZ_DECODED_CONTENT_LENGTH: HeaderName =
...
pub const X_AMZ_FWD_HEADER_CACHE_CONTROL: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-cache-control");

pub const X_AMZ_FWD_HEADER_CONTENT_DISPOSITION: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-content-disposition");

pub const X_AMZ_FWD_HEADER_CONTENT_ENCODING: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-content-encoding");

pub const X_AMZ_FWD_HEADER_CONTENT_LANGUAGE: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-content-language");

pub const X_AMZ_FWD_HEADER_CONTENT_RANGE: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-content-range");

pub const X_AMZ_FWD_HEADER_CONTENT_TYPE: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-content-type");

pub const X_AMZ_FWD_HEADER_E_TAG: HeaderName = HeaderName::from_static("x-amz-fwd-header-etag");

pub const X_AMZ_FWD_HEADER_EXPIRES: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-expires");

pub const X_AMZ_FWD_HEADER_LAST_MODIFIED: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-last-modified");

pub const X_AMZ_FWD_HEADER_ACCEPT_RANGES: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-accept-ranges");

pub const X_AMZ_FWD_HEADER_X_AMZ_CHECKSUM_CRC32: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-checksum-crc32");

pub const X_AMZ_FWD_HEADER_X_AMZ_CHECKSUM_CRC32C: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-checksum-crc32c");
...
pub const X_AMZ_FWD_HEADER_X_AMZ_CHECKSUM_SHA1: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-checksum-sha1");

pub const X_AMZ_FWD_HEADER_X_AMZ_CHECKSUM_SHA256: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-checksum-sha256");

pub const X_AMZ_FWD_HEADER_X_AMZ_DELETE_MARKER: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-delete-marker");

pub const X_AMZ_FWD_HEADER_X_AMZ_EXPIRATION: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-expiration");

pub const X_AMZ_FWD_HEADER_X_AMZ_MISSING_META: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-missing-meta");

pub const X_AMZ_FWD_HEADER_X_AMZ_MP_PARTS_COUNT: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-mp-parts-count");
...
pub const X_AMZ_FWD_HEADER_X_AMZ_REQUEST_CHARGED: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-request-charged");

pub const X_AMZ_FWD_HEADER_X_AMZ_RESTORE: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-restore");
...
pub const X_AMZ_FWD_HEADER_X_AMZ_STORAGE_CLASS: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-storage-class");

pub const X_AMZ_FWD_HEADER_X_AMZ_TAGGING_COUNT: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-tagging-count");

pub const X_AMZ_FWD_HEADER_X_AMZ_VERSION_ID: HeaderName =
    HeaderName::from_static("x-amz-fwd-header-x-amz-version-id");
...
pub const X_AMZ_IF_MATCH_INITIATED_TIME: HeaderName =
    HeaderName::from_static("x-amz-if-match-initiated-time");

pub const X_AMZ_IF_MATCH_LAST_MODIFIED_TIME: HeaderName =
    HeaderName::from_static("x-amz-if-match-last-modified-time");
...
pub const X_AMZ_OBJECT_LOCK_LEGAL_HOLD: HeaderName =
...
pub const X_AMZ_OBJECT_LOCK_RETAIN_UNTIL_DATE: HeaderName =
...
pub const X_AMZ_OPTIONAL_OBJECT_ATTRIBUTES: HeaderName =
    HeaderName::from_static("x-amz-optional-object-attributes");

pub const X_AMZ_PART_NUMBER_MARKER: HeaderName =
    HeaderName::from_static("x-amz-part-number-marker");

pub const X_AMZ_REPLICATION_STATUS: HeaderName =
...
pub const X_AMZ_RESTORE_OUTPUT_PATH: HeaderName =
    HeaderName::from_static("x-amz-restore-output-path");
...
pub const X_AMZ_SKIP_DESTINATION_VALIDATION: HeaderName =
    HeaderName::from_static("x-amz-skip-destination-validation");

pub const X_AMZ_SOURCE_EXPECTED_BUCKET_OWNER: HeaderName =
...
pub const X_AMZ_WRITE_OFFSET_BYTES: HeaderName =
    HeaderName::from_static("x-amz-write-offset-bytes");
