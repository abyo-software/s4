...
pub fn create_canonical_request(
...

    {
        ...
        match payload {
            ...
            Payload::MultipleChunksWithTrailer => {
                ans.push_str("STREAMING-AWS4-HMAC-SHA256-PAYLOAD-TRAILER")
            }
            Payload::UnsignedMultipleChunksWithTrailer => {
                ans.push_str("STREAMING-UNSIGNED-PAYLOAD-TRAILER")
            }
        }
    }
...
mod tests {
    ...
    fn example_get_object() {
        ...
        let signature =
            calculate_signature(&string_to_sign, &secret_access_key, &date, region, service);
        assert_eq!(
            signature,
    ...
    fn example_put_object_multiple_chunks_chunk_signature() {
        ...
        let chunk1_signature = calculate_signature(
            &chunk1_string_to_sign,
            &secret_access_key,
            &date,
            region,
        ...
        let chunk2_signature = calculate_signature(
            &chunk2_string_to_sign,
            &secret_access_key,
            &date,
            region,
        ...
        let chunk3_string_to_sign =
            create_chunk_string_to_sign(&date, region, service, &chunk2_signature, &[]);
        assert_eq!(
        ...
        let chunk3_signature = calculate_signature(
            &chunk3_string_to_sign,
            &secret_access_key,
            &date,
            region,
    ...
    fn example_put_object_multiple_chunks_with_trailer_trailer_signature() {
        ...
        let trailer_string_to_sign = create_trailer_string_to_sign(
            &date,
            region,
            service,
            prev_signature,
        ...
        let trailer_signature = calculate_signature(
            &trailer_string_to_sign,
            &secret_access_key,
            &date,
            region,
    ...
    fn special_20230204() {
        ...
        *req.uri_mut() = hyper::Uri::from_static(
...

        {
            ...
            assert_eq!(
                signature,
                "96ad058ca27352e0fc2bd4efd8973792077570667bdaf749655f42e204bc649c"
            );
        }
    }
        ...
        *req.uri_mut() = hyper::Uri::from_static("https://play.rustfs.com:7000/");
        ...
        let headers = [
            (
                ...
                "8c875471-a10a-45ad-b37e-e67e82de17d6",
            ),
            ...
            (
                "x-amz-content-sha256",
                "8e333076fe36da6633c89f2e38100cecb8e7587a1e0d6ce31838b6f68262b949",
            ),
            ("x-amz-date", x_amz_date),
            (
                "x-amz-user-agent",
        ...
        {
            let authorithy =
                HeaderValue::from_str(req.uri().authority().unwrap().as_str()).unwrap();
            req.headers_mut()
                .insert(HeaderName::from_static("host"), authorithy);
        }
...

        {
            ...
            assert_eq!(
                signature,
                "7ed3ea6c69ed841068bbdd3cc1eb92a9ae5a4b1b0635267066bd676f6edc0189"
            );
        }
    }
    ...
    fn example_put_presigned_url() {
        ...
        let string_to_sign =
            create_string_to_sign(&canonical_request, &amz_date, "us-east-1", "s3");
        let signature = calculate_signature(
            &string_to_sign,
            &secret_access_key,
            &amz_date,
    ...
    fn example_put_presigned_url_with_content_type() {
        ...
        assert_eq!(
            signature,
            "fd31b71961609f4b313497cb07ab0aedd268863bd547cc198db23cf04b8f663d"
        );
    }
    ...
    fn multi_value_headers_combined_with_comma() {
        ...
        let canonical_request =
            create_canonical_request(&method, "/bucket/key", qs, &headers, Payload::empty());
    ...
    fn multi_value_headers_presigned_url() {
        ...
        let canonical_request =
            create_presigned_canonical_request(&method, "/bucket/key", qs, &headers);
        ...
        let count = signed_headers_line
            .matches("x-amz-object-attributes")
            .count();
        assert_eq!(
            count, 1,
            "x-amz-object-attributes should appear only once in SignedHeaders"
        );
    }
