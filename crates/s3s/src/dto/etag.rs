...
mod tests {
    ...
    fn parse_unquoted_strong_etag() {
        ...
        let etag = ETag::parse_http_header(b"4fcec74691ff529f6d016ec3629ff11b")
            .expect("parse unquoted md5");
        assert_eq!(etag.as_strong(), Some("4fcec74691ff529f6d016ec3629ff11b"));

        // Multipart upload ETag format (hash-partcount)
        let etag = ETag::parse_http_header(b"4fcec74691ff529f6d016ec3629ff11b-5")
