    ...
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| {
            ...
            match b {
                ...
                b"ap-northeast-1" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_NORTHEAST_1))
                }
                b"ap-northeast-2" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_NORTHEAST_2))
                }
                b"ap-northeast-3" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_NORTHEAST_3))
                }
                ...
                b"ap-southeast-1" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_1))
                }
                b"ap-southeast-2" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_2))
                }
                b"ap-southeast-3" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_3))
                }
                b"ap-southeast-4" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_4))
                }
                b"ap-southeast-5" => {
                    Ok(Self::from_static(BucketLocationConstraint::AP_SOUTHEAST_5))
                }
                ...
                b"cn-northwest-1" => {
                    Ok(Self::from_static(BucketLocationConstraint::CN_NORTHWEST_1))
                }
...
impl<'xml> DeserializeContent<'xml> for GetBucketMetadataTableConfigurationResult {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        ...
        let mut metadata_table_configuration_result: Option<MetadataTableConfigurationResult> =
            None;
            ...
            b"Grantee" => {
                ...
                for attr in start.attributes() {
                    let Ok(attr) = attr else {
                        return Err(DeError::InvalidAttribute);
                    };
    ...
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| {
            ...
            match b {
                ...
                b"ChecksumAlgorithm" => Ok(Self::from_static(
                    InventoryOptionalField::CHECKSUM_ALGORITHM,
                )),
                b"ETag" => Ok(Self::from_static(InventoryOptionalField::E_TAG)),
                b"EncryptionStatus" => {
                    Ok(Self::from_static(InventoryOptionalField::ENCRYPTION_STATUS))
                }
                b"IntelligentTieringAccessTier" => Ok(Self::from_static(
                    InventoryOptionalField::INTELLIGENT_TIERING_ACCESS_TIER,
                )),
                b"IsMultipartUploaded" => Ok(Self::from_static(
                    InventoryOptionalField::IS_MULTIPART_UPLOADED,
                )),
                b"LastModifiedDate" => Ok(Self::from_static(
                    InventoryOptionalField::LAST_MODIFIED_DATE,
                )),
                b"ObjectAccessControlList" => Ok(Self::from_static(
                    InventoryOptionalField::OBJECT_ACCESS_CONTROL_LIST,
                )),
                b"ObjectLockLegalHoldStatus" => Ok(Self::from_static(
                    InventoryOptionalField::OBJECT_LOCK_LEGAL_HOLD_STATUS,
                )),
                b"ObjectLockMode" => {
                    Ok(Self::from_static(InventoryOptionalField::OBJECT_LOCK_MODE))
                }
                b"ObjectLockRetainUntilDate" => Ok(Self::from_static(
                ...
                b"ReplicationStatus" => Ok(Self::from_static(
...
impl<'xml> DeserializeContent<'xml> for ListBucketIntelligentTieringConfigurationsOutput {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        let mut continuation_token: Option<Token> = None;
        let mut intelligent_tiering_configuration_list: Option<
    ...
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| {
            ...
            match b {
                ...
                b"bucket-owner-full-control" => Ok(Self::from_static(
        ...
        d.text(|s| {
            ...
            match b {
                ...
                b"INTELLIGENT_TIERING" => {
                    Ok(Self::from_static(ObjectStorageClass::INTELLIGENT_TIERING))
                }
                b"ONEZONE_IA" => Ok(Self::from_static(ObjectStorageClass::ONEZONE_IA)),
                b"OUTPOSTS" => Ok(Self::from_static(ObjectStorageClass::OUTPOSTS)),
                b"REDUCED_REDUNDANCY" => {
                    Ok(Self::from_static(ObjectStorageClass::REDUCED_REDUNDANCY))
                }
...
impl<'xml> DeserializeContent<'xml> for ServerSideEncryptionRule {
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        let mut apply_server_side_encryption_by_default: Option<ServerSideEncryptionByDefault> =
            None;
    ...
    fn deserialize_content(d: &mut Deserializer<'xml>) -> DeResult<Self> {
        d.text(|s| {
            ...
            match b {
                ...
                b"INTELLIGENT_TIERING" => Ok(Self::from_static(
